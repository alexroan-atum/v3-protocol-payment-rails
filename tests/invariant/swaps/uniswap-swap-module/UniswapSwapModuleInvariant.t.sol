...
import { UniswapSwapModuleHandler, SwapPaymentRailsProxy } from "./UniswapSwapModuleHandler.sol";
import { MockERC20 } from "../../../shared/mocks/MockERC20.sol";
import { MockRouter } from "../../../shared/mocks/MockRouter.sol";

/// @title UniswapSwapModuleInvariant
/// @notice Foundry stateful fuzz (invariant) tests for UniswapSwapModule.
///
/// ## Why Invariants?
...
///   UniswapSwapModule is stateless — no token residuals.
///
...
///
/// ## Running
///   forge test --match-contract UniswapSwapModuleInvariant --runs 1000
///   forge test --match-contract UniswapSwapModuleInvariant --runs 10000  # thorough
contract UniswapSwapModuleInvariant is Test {
    /*//////////////////////////////////////////////////////////////////////////
                                    SETUP
    //////////////////////////////////////////////////////////////////////////*/

    UniswapSwapModule internal module;
    UniswapSwapModuleHandler internal handler;
    ...
    function setUp() public {
        ...
        module = new UniswapSwapModule(moduleOwner);
        ...
        handler = new UniswapSwapModuleHandler(module, paymentRails, sellToken, buyToken, router, moduleOwner);
    ...
    /// @dev UniswapSwapModule is stateless: _returnLeftover sends back unconsumed sellToken,
